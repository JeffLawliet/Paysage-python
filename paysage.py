...
def dessineArbre1(xArbre1=0,yArbre1=0, demander = 0):
    if demander == 0:
        xArbre1 = lireEntierClavier("Entrez le x de l'arbre : ", LARGEUR_MIN, LARGEUR_MAX)
        yArbre2 = lireEntierClavier("Entrez le y de l'arbre : ", HAUTEUR_MIN, HAUTEUR_MAX)
